    ...
    return LaunchDescription([
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"6a191cc369e4685a4d03cc68","mode":"speed","max_speed":6.2832,"reverse":false,"timeout_s":0}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"6a191cc669e4685a4d03ccf2","mode":"speed","max_speed":6.2832,"reverse":false,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"},{"pin_id":"69a3e541cd15153dec61d7af:state","name":"state","direction":"output","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"6a191cbd69e4685a4d03cb57","mode":"speed","max_speed":6.2832,"reverse":true,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"},{"pin_id":"69a3e541cd15153dec61d7af:state","name":"state","direction":"output","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"6a191cc069e4685a4d03cbdc","mode":"speed","max_speed":6.2832,"reverse":true,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"},{"pin_id":"69a3e541cd15153dec61d7af:state","name":"state","direction":"output","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"device_index":0,"poll_rate_hz":60,"deadzone":0.2,"max_linear_speed":2,"max_angular_speed":1,"wheel_separation":0.24,"output_mode":"diff_drive"}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_INBOUND_CONNECTIONS": json.dumps(json.loads('[{"connection_id":"69fab44733de1472f9828dd3","source_node_id":"69f0339c86ddc7307fba51e9","source_pin_id":"cmd_vel","target_pin_id":"cmd_vel_teleop"},{"connection_id":"6a04c7f8f3f3cdb377101cb9","source_node_id":"6a04c7f2f3f3cdb377101be8","source_pin_id":"cmd_vel","target_pin_id":"cmd_vel_automated"}]')),

    ...
    return LaunchDescription([
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69eaea6f650da4466a52d3bc","mode":"speed","max_speed":360,"reverse":false,"timeout_s":0}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69eaea69650da4466a52d346","mode":"speed","max_speed":360,"reverse":false,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69eb7517650da4466a52d9c4","mode":"speed","max_speed":360,"reverse":true,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69eb7514650da4466a52d93e","mode":"speed","max_speed":360,"reverse":true,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"wheel_radius":0.095,"wheel_separation":0.24,"max_wheel_speed":360,"teleop_timeout_s":1}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),

    ...
    return LaunchDescription([
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69fe6819f3f3cdb3770f7095","mode":"speed","max_speed":18.326,"reverse":true,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69fe681cf3f3cdb3770f7130","mode":"speed","max_speed":18.326,"reverse":true,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69fe6812f3f3cdb3770f6f72","mode":"speed","max_speed":18.326,"reverse":false,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
        ...
        Node(
            ...
            additional_env={
                ...
                "POLYFLOW_PARAMETERS": json.dumps(json.loads('{"motor_id":"69fe6816f3f3cdb3770f7001","mode":"speed","max_speed":18.326,"reverse":false,"timeout_s":0}')),
                "POLYFLOW_CONFIGURATION": json.dumps(json.loads('{"namespace":null,"rate_hz":50,"lifecycle":null}')),
                "POLYFLOW_PINS": json.dumps(json.loads('[{"pin_id":"69a3e541cd15153dec61d7af:command","name":"command","direction":"input","msg_type":"std_msgs/Float64"}]')),
